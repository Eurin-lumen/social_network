...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Eurin">

    <title>Boom Social Network</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
          <h1>Boom Social Network ?</h1>
        <p>
        Boom Social Network est un réseau social pour développeurs &#9993;. <br>
        Et qui dit dévellopeur dite code source! &#9997; <br>
        ...
        Alors n'hésitez plus et <a href="inscription.php">Rejoingnez-nous dès maintenant</a> &#9786; <br>
        </p>

        <a href="inscription.php" class="btn btn-primary btn-lg">Je m'inscris</a>
      </div>
